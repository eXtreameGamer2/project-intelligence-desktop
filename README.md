...
https://github.com/eXtreameGamer2/project-intelligence-desktop/releases/tag/v1.0.25

Use **`Project-Intelligence-Local-Setup-1.0.25.exe`**. Do not install from git. The Setup file is larger than GitHub’s 100MB git limit, so it is not in the repo.
